...
public abstract class Player {
     ...
     * <p>Extended by {@link HumanPlayer} and {@link BotPlayer}.</p>
     * <p>Sets name as playerName given as a parameter,<br>
    ...
    //Add here a link to the addShipForPlayer method in Sea.java
    /**
     * Forwards the given index and ship information to the ADD LINK HERE linked with the player.
     ...
     * <p>Uses a for-loop to add all values to the ArrayList ships in ascending order.</p>
